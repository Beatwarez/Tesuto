...
void KronosAudioProcessorEditor::timerCallback()
{
    ...
    juce::String paramIDs[22] = { "form", "timbre", "filter", "space", "alter", "size", "sweep", "cloud", "attack", "decay", "sustain", "release", "desync", "pitch", "filterCutoff", "filterCutoffMod", "filterMorph", "filterOffset", "filterReso", "filterSlope", "filterTypeA", "filterTypeB" };
    for (int p = 0; p < 22; ++p)
    {
