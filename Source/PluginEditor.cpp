...
void KronosAudioProcessorEditor::timerCallback()
{
    ...
    juce::String paramIDs[25] = { "form", "timbre", "filter", "space", "alter", "size", "sweep", "cloud", "attack", "decay", "sustain", "release", "desync", "pitch", "filterCutoff", "filterCutoffMod", "filterMorph", "filterOffset", "filterOffsetMod", "filterReso", "filterResoMod", "filterSlope", "filterSlopeMod", "filterTypeA", "filterTypeB" };
    for (int p = 0; p < 25; ++p)
    {
