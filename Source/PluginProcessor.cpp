...
KronosAudioProcessor::KronosAudioProcessor()
     ...
     : AudioProcessor (BusesProperties()
        ...
        apvts (*this, nullptr, "PARAMETERS", {
            ...
            std::make_unique<juce::AudioParameterInt> (juce::ParameterID ("filterTypeA", 1), "FilterTypeA", 0, 9, 0),
            std::make_unique<juce::AudioParameterInt> (juce::ParameterID ("filterTypeB", 1), "FilterTypeB", 0, 9, 0),
